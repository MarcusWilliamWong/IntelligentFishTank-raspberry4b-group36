...
class SharedPreferencesUtils{
  /// 静态私有实例对象
  static final _instance = SharedPreferencesUtils._init();
  /// 工厂构造函数 返回实例对象
  factory SharedPreferencesUtils() => _instance;
  /// SharedPreferences对象
  static SharedPreferences? _storage;
  /// 命名构造函数 用于初始化SharedPreferences实例对象
  SharedPreferencesUtils._init(){
    _initStorage();
  }
  ...
  setStorage(String key,dynamic value)async{
    ...
    switch (type) {
      ...
      case 'bool':
        ...
        break;
      default:
        _storage?.setString(key, json.encode(value));
  ...
  /// 存储  List<Object> list
  ///
  void setBeanList(BuildContext context,List<Object> list, String key) async{
    String jsonString = jsonEncode(list);
    _storage!.setString(key,jsonString);
  }

  ///
  /// 获取  List<Object> list
  ///
  Future getBeanList(BuildContext context, String key) async {
    return json.decode(_storage!.getString(key)!);
  }
}